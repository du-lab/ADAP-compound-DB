...
!function (o) {
    ...
    o.fn.tagify = function () {
        ...
        applySettings: function (t, e) {
            ...
            this.settings.mode && (this.settings.dropdown.enabled = 0)
        },
        ...
        EventDispatcher: function (s) {
            ...
            this.off = function (t, e) {
                ...
                var i;
                if (t) if (s.settings.isJQueryPlugin) o( s.DOM.originalInput ).triggerHandler( t, [e] ); else {
                    try {
        ...
        events: {
            customBinding: function () {
                ...
                for (var a in i && !this.listeners.main && (this.DOM.input.addEventListener( this.isIE ? "keydown" : "input", s[this.isIE ? "onInputIE" : "onInput"].bind( this ) ), this.settings.isJQueryPlugin && o( this.DOM.originalInput ).on( "tagify.removeAllTags", this.removeAllTags.bind( this ) )), e = this.listeners.main = this.listeners.main || {
                ...
                onFocusBlur: function (t) {
                    ...
                    var e = t.closest( "tag" ), i = this.getNodeIndex( e ), s = this.input.normalize( t ),
                        ...
                        r = _objectSpread( {}, this.value[i], {value: n} );
        ...
        normalizeTags: function (t) {
            ...
            if (l) return t = (e = []).concat.apply( e, _toConsumableArray( t.map( function (e) {
            ...
            if ("number" == typeof t && (t = t.toString()), "string" == typeof t) {
                ...
                var c;
                t = (c = []).concat.apply( c, _toConsumableArray( t.map( function (t) {
                    return i( t )
                } ) ) )
            }
        ...
        addMixTag: function (t) {
            if (t && this.state.tag) {
                for (var e, i, s, n, a = this.state.tag.prefix + this.state.tag.value, o = document.createNodeIterator( this.DOM.input, NodeFilter.SHOW_TEXT, null, !1 ), r = 100; (e = o.nextNode()) && r--;) if (e.nodeType === Node.TEXT_NODE) {
                    ...
                    n = e.splitText( s ), this.settings.transformTag.call( this, t ), i = this.createTagElem( t ), n.nodeValue = n.nodeValue.replace( a, "" ), e.parentNode.insertBefore( i, n ), i.insertAdjacentHTML( "afterend", "&#8288;" )
                }
        ...
        removeTag: function (t, e, i) {
            ...
            function d() {
                s.parentNode && (s.parentNode.removeChild( s ), n ? this.settings.keepInvalidTags && r.trigger( "remove", {
                    tag: s,
                    index: l
            ...
            init: function () {
                ...
                binding: function (t) {
                    ...
                    onKeyDown: function (t) {
                        ...
                        } else this.dropdown.hide.call( this ), t.target.closest( ".tagify" ) || this.events.callbacks.onFocusBlur.call( this, {type: "blur"} )
                    }
                }
