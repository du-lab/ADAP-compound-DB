                ...
                <ul>
                    ...
                    <c:if test="${currentUser != null}">
                        <c:if test="${dulab:isAdmin(currentUser)}">
                            <li><a href="<c:url value="/admin/" />"><i class="material-icons color-primary"
                                                                       style="color: red;">account_circle</i>Admin</a>
                            </li>
                        </c:if>
                        <li><a href="<c:url value="/account/"/>"><i class="material-icons color-primary">account_box</i>Account</a>
                        </li>
                        <li><a href="<c:url value="/logout/"/>"><i class="material-icons color-primary">transit_enterexit</i>Log
                            out</a></li>
                    </c:if>
                </ul>
            </nav>
