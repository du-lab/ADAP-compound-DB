...
<section>
    <div class="tabbed-pane">
        ...
        <span data-tab="mass_spectra" style="width: 33%; border-right: solid #ffffff">Mass Spectra</span>
        <span data-tab="files" style="width: 33%; border-radius: 0 10px 0 0; float: right;">Files</span>
    </div>
    <div id="submission">
        <c:choose>
