                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="row form-group">
                                                    <form:label path="mspCasNoField"
                                                                cssClass="col-md-4 col-form-label">CAS ID Field</form:label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row form-group">
                                                    <form:label path="mspHmdbField"
                                                                cssClass="col-md-4 col-form-label">HMDB ID Field</form:label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row form-group">
                                                    <form:label path="mspKeggField"
                                                                cssClass="col-md-4 col-form-label">KEGG ID Field</form:label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row form-group">
                                                    <form:label path="mspPubChemField"
                                                                cssClass="col-md-4 col-form-label">PubChem ID Field</form:label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row form-group">
                                                    <form:label path="mspInChiField"
                                                                cssClass="col-md-4 col-form-label">InChI Field</form:label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row form-group">
                                                    <form:label path="mspInChiKeyField"
                                                                cssClass="col-md-4 col-form-label">InChIKey Field</form:label>
                                                    <div class="col-md-4">
