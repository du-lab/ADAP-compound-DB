    ...
    <div class="row row-content">
        <div class="col">
            <div class="btn-toolbar justify-content-end" role="toolbar">
                ...
                <a class="btn btn-danger btn-secondary mr-2" style="display: none;" data-toggle="modal"
                   data-target="#yesNoModal" id="stopSearchBtn">Stop Search</a>
        ...
        <div class="my-filter">
            <div class="items">
                <span class="material-icons"
                      style="margin-bottom: 6px;margin-right: 3px; color:#844d36; width:25px; height:25px">filter_list</span>
                <h5>Filters: </h5>
            </div>
            <div class="custom-control custom-switch items">
                <input type="checkbox" class="custom-control-input" id="matchesOnly" checked/>
                <label class="custom-control-label" for="matchesOnly" style="margin-bottom: 0;">Show only results with
                    matches</label>
            </div>
            <div class="items">
            ...
            <div class="items">
                <label for="scoreThreshold" title="Results with score above the threshold will be shown">Score
                    Threshold</label>
                <input type="number" step="any" id="scoreThreshold" placeholder="0-1000"
                       class="form-control item-textbox"/>
            </div>
            <div class="items">
                <label for="massError" title="Results with mass error below given value will be shown">Mass Error
                    Tolerance (Da)</label>
                <input type="number" step="any" id="massError" class="form-control item-textbox"/>
            </div>
            <div class="items">
                <label for="retTimeError" title="Results with retention time error below given value will be shown">Retention
                    Time Error Tolerance (min)</label>
    ...
    <div class="card" style="margin-left: 5px;margin-right: 5px;">
        <div class="card-header card-header-single">
            <button class="btn btn-sm btn-link" type="button" data-toggle="collapse"
                    data-target="#query-plot-match-panel" aria-expanded="false" aria-controls="query-plot-match-panel">
