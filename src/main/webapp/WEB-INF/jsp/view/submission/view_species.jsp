<%--@elvariable id="species" type="java.util.List<org.dulab.adapcompounddb.site.controllers.SubmissionSpecimenController.SpecimenWithSubmissionCount>"--%><%--@elvariable id="submissionCounts" type="java.util.List<java.lang.Long>"--%>
