...
public class OntologySupplier {
    ...
    static {
        ...
        OntologyLevel ol1 = new OntologyLevel("OL_1", 1, true, Parameters.MZ_TOLERANCE,
                Parameters.SCORE_THRESHOLD, Parameters.PRECURSOR_TOLERANCE, Parameters.MASS_TOLERANCE,
        ...
        OntologyLevel ol2a = new OntologyLevel("OL_2a", 2, true, null,
                null, null,  Parameters.MASS_TOLERANCE, Parameters.RET_TIME_TOLERANCE);
        ...
        OntologyLevel ol2b = new OntologyLevel("OL_2b", 2, true, Parameters.MZ_TOLERANCE,
                Parameters.SCORE_THRESHOLD, Parameters.PRECURSOR_TOLERANCE, Parameters.MASS_TOLERANCE, null);
