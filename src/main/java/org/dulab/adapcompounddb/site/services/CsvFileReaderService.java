...
public class CsvFileReaderService implements FileReaderService {
    ...
    private static final String WEIGHT_HEADER = "molecular weight";


    @Override
    public List<Spectrum> read(InputStream inputStream, ChromatographyType type) throws IOException {
